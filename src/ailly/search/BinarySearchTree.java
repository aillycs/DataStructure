...
public class BinarySearchTree<Key extends Comparable<Key>, Value> {
    ...
    public static void main(String[] args) {
        ...
        String str = "Backpropagation allowed us to measure how each weight in the network contributed to the overall error This ultimately allowed us to change these weights using a different algorithm Gradient Descent";
